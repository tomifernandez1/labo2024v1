...
PARAM$semillas <- c(889963, 381673, 961679, 604433, 770767)

#------------------------------------------------------------------------------
# particionar agrega una columna llamada fold a un dataset
#  que consiste en una particion estratificada segun agrupa
# particionar( data=dataset, division=c(70,30), agrupa=clase_ternaria, seed=semilla) # nolint
...
# delete the 'clase_ternaria' column
...
for (vmax_depth in c(4, 6, 8, 10, 12)){
  for (vmin_split in c(80,160,320,640)){ 
    for (vcp in c(-0.5,-0.3,-0.2,-0.1)){
      for (vminbucket in round(c(vmin_split/4,vmin_split/3,vmin_split/2,10,5,2))){
