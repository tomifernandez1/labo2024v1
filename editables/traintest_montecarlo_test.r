...
PARAM$semillas <- c(617,23,313,757,647)
...
setwd("C:/Users/tomif/Desktop/Maestria/laboratorio_1") # Establezco el Working Directory
# cargo los datos

# cargo los datos
dataset <- fread("C:/Users/tomif/Desktop/Maestria/laboratorio_1/labo2024v1-main/datasets/dataset_pequeno.csv")
...
ArbolEstimarGanancia(617, param_basicos)
