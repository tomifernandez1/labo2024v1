...
param_sets <- list(
  list(minsplit = 100, minbucket = 1, maxdepth = 4),
  list(minsplit = 250, minbucket = 20, maxdepth = 8),
  list(minsplit = 500, minbucket = 100, maxdepth = 14),
  list(minsplit = 750, minbucket = 100, maxdepth = 6),
  list(minsplit = 1000, minbucket = 200, maxdepth = 10),
  list(minsplit = 1500, minbucket = 100, maxdepth = 4),
  list(minsplit = 2000, minbucket = 100, maxdepth = 8)
)
