...
filename <- paste("./plots/MS", PARAM$minsplit, "MB", PARAM$minbucket, "MD", PARAM$maxdepth,"TRG", dataset[fold==1, max(ganancia_acumulada)],"TEG", dataset[fold==2, max(ganancia_acumulada)], ".png", sep = "")
