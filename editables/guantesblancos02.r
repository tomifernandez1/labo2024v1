...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  #  los que tienen un vector,  son los que participan de la Bayesian Optimizationd
  ...
  param_local$lgb_param <- list(
    ...
    drop_rate = 0.25, # 0.0 < neg_bagging_fraction <= 1.0
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_dart", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_dart", "DT0001_dart" )

  DR_drifting_guantesblancos( "DR0001_dart", "CA0001_dart" )
  FE_historia_guantesblancos( "FE0001_dart", "DR0001_dart" )

  TS_strategy_guantesblancos_202109( "TS0001_dart", "FE0001_dart" )

  HT_tuning_guantesblancos( "HT0001_dart", "TS0001_dart" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_dart", c("HT0001_dart","TS0001_dart") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_dart", "FE0001_dart" )

  HT_tuning_guantesblancos( "HT0002_dart", "TS0002_dart" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_dart", c("HT0002_dart", "TS0002_dart") )
